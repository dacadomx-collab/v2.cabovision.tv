...
<div class="admin-shell">
    <div class="admin-topbar">
        ...
        <nav>
            ...
            <a href="/CaboVision.tv/admin/sponsors_dashboard.php" class="is-active">Dashboard B2B</a>
...
<script src="/CaboVision.tv/assets/js/sponsors_dashboard.js" defer></script>
</body>
</html>
